...
def cleaning(input_file1, input_file2, output_file, pattern=r'^S...C.........C', library="WL0.SDB21", baseline="WL0.SDB17"):
    ...
    # Preprocess the data
    df1 = preprocess_data(df1, pattern=pattern, library="WL0.SDB21", baseline="WL0.SDB17")
    df2 = preprocess_data(df2, pattern=pattern, library="WL0.SDB21", baseline="WL0.SDB17")
