...
def parse_arguments():
    ...
    parser.add_argument('--library', type=str, default='EJ0.SDB21',
                      help='Library identifier')
    parser.add_argument('--baseline', type=str, default='EJ0.SDB17',
                      help='Baseline identifier')
    parser.add_argument('--motif', type=str, default='DMT',
                      help='Motif for plot generation')
    parser.add_argument('--inputtiter', type=float, default=9.75e8,
                      help='Input titer value')
    parser.add_argument('--outputtiter', type=float, default=5.43e6,
                      help='Output titer value')
